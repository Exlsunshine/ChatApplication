...
public class LoginGuideActivity extends Activity
{
	...
	private class onResetBtnClickListener implements OnClickListener
	{
		...
		public void onClick(View arg0) 
		{
			...
			{
			case 0:
				Toast.makeText(LoginGuideActivity.this, "–¬√‹¬Î“—æ≠∑¢ÀÕµΩ " + emailStr, Toast.LENGTH_SHORT).show();
				forgotDialog.cancel();
				break;
			case 1:
				...
				break;
			case 2:
				Toast.makeText(LoginGuideActivity.this, "” œ‰…–Œ¥◊¢≤·π˝£¨ƒ˙ ‰»Î” œ‰¡À?", Toast.LENGTH_SHORT).show();
			default:
				break;
			}
		}
