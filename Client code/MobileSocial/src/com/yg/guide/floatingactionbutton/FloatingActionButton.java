package com.yg.guide.floatingactionbutton;
	...
	void updateBackground() 
	{
		...
		LayerDrawable layerDrawable = new LayerDrawable(new Drawable[] {
				getResources().getDrawable(
						mSize == SIZE_NORMAL ? R.drawable.yg_tourguide_fab_bg_normal
								: R.drawable.yg_tourguide_fab_bg_mini),
