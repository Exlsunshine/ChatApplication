...
public class SatelliteMenu extends FrameLayout {
	...
	//	int totalWidth = imgMain.getWidth() + satelliteDistance + measureDiff;
		int totalHeight = imgMain.getHeight() + satelliteDistance * 2 + measureDiff;
		int totalWidth = imgMain.getWidth() + satelliteDistance * 2 + measureDiff;
