...
public class WaveSwipeRefreshLayout extends ViewGroup implements ViewTreeObserver.OnPreDrawListener
{
	...
	private boolean customEnable = true;
	...
	public boolean onInterceptTouchEvent(@NonNull MotionEvent event) {
		...
		if ((!isEnabled() || canChildScrollUp() || isRefreshing()) || (!customEnable)) {
			return false;
		}
	...
	private boolean onMoveTouchEvent(@NonNull MotionEvent event,
			int pointerIndex) {
		if ((mIsBeingDropped) || (!customEnable)) {
			return false;
		}
	...
	public boolean onTouchEvent(@NonNull MotionEvent event) {
		...
		if ((!isEnabled() || canChildScrollUp()) || (!customEnable)) {
			return false;
		}
